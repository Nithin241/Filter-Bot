...
def post_telegraph(bot: Bot, update: Update, args: List[str]):
    short_name = "Created By @Nithinofficial_admin 😬"
    msg = update.effective_message # type: Optional[Message]
    telegraph = Telegraph()
...
__help__ = """
○ My Name : *Kannada Warriors Manager RoBot*
○ Creator : [Nithinofficial_admin](http://telegram.dog/Nithinofficial_admin)
○ Credits : `Nithin and @Pro_webster`
○ Language : Python3
○ Library : [Pyrogram asyncio 0.16.1](https://docs.pyrogram.org/)
○ Source Code : 👉 [Click Here](https://t.me/NithinMovies)
○ Server : Heroku
○ Build Status : V4 `[+0.4]`
"""
